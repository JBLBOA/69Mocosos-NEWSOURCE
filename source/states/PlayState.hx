...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		scoreTxt = new FlxText(200, healthBar.y + 30, FlxG.width, "", 20);
		...
		songNameTXT = new FlxText(0, healthBar.y + 50, FlxG.width, songName+" - Normal", 20);
		songNameTXT.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, null, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		songNameTXT.scrollFactor.set();
		songNameTXT.borderSize = 1.25;
		songNameTXT.visible = !ClientPrefs.data.hideHud;
		...
		var shadercam = new FlxRuntimeShader(File.getContent(Paths.shaderFragment("ntsc")));
		if (ClientPrefs.data.shaders)
		{
		 camHUD.setFilters([new ShaderFilter(shadercam)]);
		 camOther.setFilters([new ShaderFilter(shadercam)]);
		}
	}
